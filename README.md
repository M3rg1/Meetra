...
The engine is not supposed to be run from the command line. To use it, download any GUI that supports
...
- **Evaluation**
    - [Piece-square tables](https://www.chessprogramming.org/Piece-Square_Tables)
      with [tapered evaluation](https://www.chessprogramming.org/Tapered_Eval) using
      the [PeSTO's Evaluation Function](https://www.chessprogramming.org/PeSTO%27s_Evaluation_Function)
- **Opening book**
